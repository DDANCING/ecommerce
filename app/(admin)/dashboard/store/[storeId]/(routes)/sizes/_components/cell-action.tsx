    ...
    const [open, setOpen] = useState(false)
     ...
     const onDelete = async () => {
        try {
            ...
            toast.error("certifique-se de que você removeu todos os produtos que tem este produto primeiro.")
        } finally {
            setLoading(false)
            setOpen(false)
        }
        ...
        <>
         ...
         <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="bg-muted p-2">
                ...
                <DropdownMenuItem className="flex " onClick={() => router.push(`/dashboard/store/${params.storeId}/sizes/${data.id}`)} >
